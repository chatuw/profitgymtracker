...
import com.pthl.DAO.CVSManager;
import com.pthl.DAO.DAOCardio;
import com.pthl.DAO.DAOFonte;
import com.pthl.DAO.DAOMachine;
import com.pthl.DAO.DAOProfil;
import com.pthl.DAO.DatabaseHelper;
import com.pthl.DAO.Fonte;
import com.pthl.DAO.Machine;
import com.pthl.DAO.Profile;
import com.pthl.DAO.cardio.DAOOldCardio;
import com.pthl.DAO.cardio.OldCardio;
import com.pthl.bodymeasures.BodyPartListFragment;
import com.pthl.fonte.FontesPagerFragment;
import com.pthl.intro.MainIntroActivity;
import com.pthl.machines.MachineFragment;
import com.pthl.utils.CustomExceptionHandler;
import com.pthl.utils.FileChooserDialog;
import com.pthl.utils.ImageUtil;
...
public class MainActivity extends AppCompatActivity {
    ...
    private CalorieFragment mpSettingFrag = null;
    private Links mpAboutFrag = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            //if (mpSettingFrag == null) mpSettingFrag = CalorieFragment.newInstance(SETTINGS, 8);
           // if (mpAboutFrag == null) mpAboutFrag = BMIFragment.newInstance(ABOUT, 6);
            ...
            mpSettingFrag = (CalorieFragment) getSupportFragmentManager().getFragment(savedInstanceState, SETTINGS);
            mpAboutFrag = (Links) getSupportFragmentManager().getFragment(savedInstanceState, ABOUT);
        ...
        // Intro
        // Test if the intro has already been launched
    ...
    private Links getAboutFragment() {
      return new Links();
        /*  if (mpAboutFrag == null)

            mpAboutFrag = (BMIFragment) getSupportFragmentManager().findFragmentByTag(ABOUT);
        if (mpAboutFrag == null) mpAboutFrag = BMIFragment.newInstance(ABOUT, 6);
    ...
    private CalorieFragment getSettingsFragment() {
