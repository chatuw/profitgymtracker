...
import com.pthl.DAO.DAOWeight;
import com.pthl.DAO.Profile;
import com.pthl.DAO.bodymeasures.BodyMeasure;
import com.pthl.DAO.bodymeasures.BodyPart;
import com.pthl.DAO.bodymeasures.DAOBodyMeasure;
import com.pthl.bodymeasures.BodyPartDetailsFragment;
import com.pthl.utils.EditableInputView.EditableInputView;
import com.pthl.utils.EditableInputView.EditableInputViewWithDate;
import com.pthl.utils.Gender;
...
public class WeightFragment extends Fragment {
    ...
    private EditableInputView.OnTextChangedListener itemOnTextChange = view -> {
        ...
        //float wnull= Float.parseFloat(null);
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.fatInput:
                    ...
                    if(fatValue==100||fatValue<100){
                    mDbBodyMeasure.addBodyMeasure(v.getDate(), BodyPart.FAT, fatValue, getProfil().getId());
                }else{
                    KToast.warningToast(getActivity(), "Please enter a value below 100".toString(), Gravity.BOTTOM, KToast.LENGTH_SHORT);
                       //fatValue=wnull;
                        fatEdit.setText(null);
